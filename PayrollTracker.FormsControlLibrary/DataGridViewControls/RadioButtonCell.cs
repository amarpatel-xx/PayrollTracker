...
{
    public class RadioButtonCell : DataGridViewComboBoxCell, IDataGridViewEditingCell
    {
        /// <summary>
        ...
        private RadioButtonCellLayout layout;   // represents the current layout information of the cell
        ...
        public RadioButtonCell()
        {
            ...
            this.layout = new RadioButtonCellLayout();
        ...
        {
            RadioButtonCell dataGridViewCell = base.Clone() as RadioButtonCell;
        ...
        private void ComputeLayout(Graphics graphics,
                                   ...
                                   bool paint)
        {
            if (paint && RadioButtonCell.PartPainted(paintParts, DataGridViewPaintParts.Border))
            {
            ...
            try
            {
                ...
                if (RadioButtonCell.PartPainted(paintParts, DataGridViewPaintParts.SelectionBackground) && cellSelected)
                {
                ...
                if (paint && RadioButtonCell.PartPainted(paintParts, DataGridViewPaintParts.Background) && backgroundBrush.Color.A == 255)
                {
                ...
                if (valBounds.Width > 0 && valBounds.Height > 0)
                {
                    ...
                    {
                        if (paint && RadioButtonCell.PartPainted(paintParts, DataGridViewPaintParts.ContentBackground))
                        {
                            ...
                            if (!itemRect.IsEmpty)
                            {
                                ...
                                PaintItem(graphics, 
                                          ...
                                          itemSelected, 
                                          mouseOverCell,
                                          cellCurrent && this.focusedItemIndex == itemIndex && RadioButtonCell.PartPainted(paintParts, DataGridViewPaintParts.Focus));
                            }
                        }
                        itemIndex++;
                ...
                if (paint && 
                    RadioButtonCell.PartPainted(paintParts, DataGridViewPaintParts.ErrorIcon) &&
        ...
        protected override Size GetPreferredSize(Graphics graphics, DataGridViewCellStyle cellStyle, int rowIndex, Size constraintSize)
        {
            ...
            DataGridViewRadioButtonFreeDimension freeDimension = RadioButtonCell.GetFreeDimensionFromConstraint(constraintSize);

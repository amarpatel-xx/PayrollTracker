...
namespace PayrollTracker.FormsControlLibrary.DataGridViewControls
{
    ...
    public class RadioButtonColumn : DataGridViewColumn
    {
        ...
        public override DataGridViewCell CellTemplate
        {
            ...
            set
            {
                RadioButtonCell dataGridViewRadioButtonCell = value as RadioButtonCell;
            ...
            set
            {
                ...
                if (this.DataGridView != null)
                {
                    ...
                    for (int rowIndex = 0; rowIndex < rowCount; rowIndex++)
                    {
                        ...
                        RadioButtonCell dataGridViewCell = dataGridViewRow.Cells[this.Index] as RadioButtonCell;
        ...
        public RadioButtonCell.ObjectCollection Items
        {
            get
            {
                if (this.RadioButtonCellTemplate == null)
        ...
        [
            Category("Behavior"),
            DefaultValue(RadioButtonCell.DATAGRIDVIEWRADIOBUTTONCELL_defaultMaxDisplayedItems),
        ...
        /// </summary>
        private RadioButtonCell RadioButtonCellTemplate
        {
            get
            {
                return (RadioButtonCell)this.CellTemplate;
            }
        }
        ...
        public void NotifyItemsCollectionChanged()
        {
            if (this.DataGridView != null)
            {
                DataGridViewRowCollection dataGridViewRows = this.DataGridView.Rows;
                int rowCount = dataGridViewRows.Count;
                RadioButtonCell cellTemplate = this.CellTemplate as RadioButtonCell;
